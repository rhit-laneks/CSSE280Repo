...
rhit.FbAuthManager = class {
	...
	signIn() {
		...
		Rosefire.signIn("5fb727da-2081-43e6-bb44-0612c68b7a93", (err, rfUser) => {
			if (err) {
...
rhit.main = function () {
	console.log("Ready");
	rhit.fbAuthManager = new rhit.FbAuthManager(); /* need to be able to access on every page to know who is signed in */
